...
%
Our compiler analyzes these specifications and translates them to a collection of BGP configurations, so they may
exploit existing distributed fault tolerance mechanisms and
execute on existing commodity hardware.  
%
The compiled configurations are guaranteed to correctly implement the routing policy under all possible combinations of failures.
%

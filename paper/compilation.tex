...
%
Finally, there is an edge from each node in the PGIR such that $P(v) \neq \emptyset$ to the special end node $e$.  This product construction is a variation on
the construction used in Merlin~\cite{foster:merlin}, extended to manage
preferences.

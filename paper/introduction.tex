...
manually decompose policies into per-device behaviors.
...
\emph{inter}-domain routes.  \todd{What is the impact of these
  ...
  impact would help.}  Second, centralized control planes
...
guaranteed to satisfy the given policy specification in the face of

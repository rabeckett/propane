...
This means that existing inter-domain routing protocols and their associated configuration difficulties will be around for the forseeable future.
\ryan{I added this. Is it true? what about SDX?}
\todd{What is the impact of these
  languages not supporting inter-domain routing?  How are those
  policies expressed instead in an SDN context?  A sentence on the
  impact would help.}  

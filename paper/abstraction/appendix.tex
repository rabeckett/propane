...
\begin{defn}
  ...
  Clearly from Lemma 9, $\Pref(m) \leq \Pref(m') \iff m \leq m'$ and $\Pref(f_{pg}(m)) \leq \Pref(f_{pg}(m')) \iff f_{pg}(m) \leq f_{pg}(m')$
\end{defn}
...
\begin{thm}
  ...
  \begin{proof} 
    ...
    \begin{array}{llll}
      ...
      &=& \Con(\CompileMbgp([\CompilePg(p_1), \ldots, \CompilePg(p_n)]),\Gamma,f,G)
            & \text{Definition of Compile} \\
    ...
    \[ \begin{array}{l}
     ~~~~~ [~ \ell \rightarrow rc ~\vert~ \\
     ~~~~~~~~~~~~ l \in internal(G^A.V), \\ 
     ~~~~~~~~~~~~ rc = [\CompilePred((t_i, PG^A_i, \Pref^A_i))] ~~] \\
    \end{array} \]%
    ...
    \[ \begin{array}{l}
     ~~~~~ [~ \ell \rightarrow rc ~\vert~ \\
     ~~~~~~~~~~~~ l \in internal(G.V), \\ 
     ~~~~~~~~~~~~ rc = [\CompilePred((t'_i, PG_i, \Pref_i))] ~~] \\
    \end{array} \]%


    \noindent
    By applying the definition of $\CompileMbgp$, we need to show:

    \[ \begin{array}{l}
     ~~~~~ [~ \ell \rightarrow rc ~\vert~ \\
     ~~~~~~~~~~~~ l \in internal(G^A.V), \\ 
     ~~~~~~~~~~~~ rc = append_{i \in \{1..n\}}(\CompilePred((t_i, PG^A_i, \Pref^A_i))) ~] \\
    \end{array} \]%
    ...
    \noindent
    Clearly this follows by the definition of list $\mathrm{append}$

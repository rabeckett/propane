...
\begin{lem}
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ M = (l,q_M) \in PG^A, \\
     ~~~~~~~~~~~~~~~~~~ I = \mathit{adjIn}(PG^A,M), \\
     ~~~~~~~~~~~~~~~~~~ (in,q_N) \in \{(BS,q_N) ~\vert~ (\_,q_N) \in I, BS=\{b ~\vert~ b \in f^{-1}(B),~ (b,\ell) \in G.E,~ (B,q_N) \in I \} \}) \\
     ~~~~~~~~~~~~~~~~~~ out = \{ c ~\vert~ c \in f^{-1}(C), (c,\ell) \in G.E, (C,\_) \in \mathit{adjOut}(PG^A,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A(M) : (in,q_N) \rightarrow (out,q_M) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ out = \{ c ~\vert~ (c,\_) \in \mathit{adjOut}(PG,m) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A(f_{pg}(m)) : (in,q_N) \rightarrow (out,q_M) ~] \\
  \end{array} \]%

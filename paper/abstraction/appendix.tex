...
Unfold definition of $\text{compile}_\text{ABGP}$
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~ [~ t_i \rightarrow ma_1, \dots, ma_k ~\vert~ \\
     ~~~~~~~~~~~~~~~~~~~~~ M = (l,q_M) \in PG^A_i, \\
     ~~~~~~~~~~~~~~~~~~~~~ pin = \text{adjIn}(PG^A_i,M), \\
     ~~~~~~~~~~~~~~~~~~~~~ (in,q_n) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (in,q_N) \rightarrow (out,q_M) ~] ~], \Gamma,f,G) \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (bs,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_n) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (in,q_N) \rightarrow (out,q_M) ~] ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~~~~ ma_j = ord^A_i(m) : (in,q_N) \rightarrow (out,q_M) ~],\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (in,q_N) \rightarrow (out,q_M) ~],\ell,\Gamma,f,G) \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = con(ord^A_i(M) : (in,q_N) \rightarrow (out,q_M),\text{true},\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (con(in,\ell,\Gamma,f,G),q_N) \rightarrow (con(out,\ell,\Gamma,f,G),q_M),\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ M = (l,q_M) \in PG^A_i, \\
     ~~~~~~~~~~~~~~~~~~ pin = \text{adjIn}(PG^A_i,M), \\
     ~~~~~~~~~~~~~~~~~~ (con(in,\ell,\Gamma,f,G),q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ M = (l,q_M) \in PG^A_i, \\
     ~~~~~~~~~~~~~~~~~~ pin = \text{adjIn}(PG^A_i,M), \\
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=con(\{B ~\vert~ (B,q_N) \in pin \},\ell,\Gamma,f,G) \} \\
     ~~~~~~~~~~~~~~~~~~ out = con(\{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \},\ell,\Gamma,f,G)) \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (in,q_N) \rightarrow (out,q_M),\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ M = (l,q_M) \in PG^A_i, \\
     ~~~~~~~~~~~~~~~~~~ pin = \text{adjIn}(PG^A_i,M), \\
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{b ~\vert~ b \in f^{-1}(B),~ (b,\ell) \in G.E,~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{c~\vert~ c \in f^{-1}(C),~ (c,\ell) \in G.E,~ (C,\_) \in \text{adjOut}(PG^A_i,M) \},\ell,\Gamma,f,G)) \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(M) : (in,q_N) \rightarrow (out,q_M),\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ~~~~~~~~~ [~ \Pfx_{i1} \rightarrow ma_1, \dots, ma_k ~\vert~ \\
     ~~~~~~~~~~~~~~~~~~ m = (l,q_M) \in PG_{i1}, \\
     ~~~~~~~~~~~~~~~~~~ pin = \text{adjIn}(PG_{i1},m), \\
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (bs,q_N) ~\vert~ (\_,q_N) \in pin, bs=\{ b ~\vert~ (b,q_N) \in ping \} \}) \\
     ~~~~~~~~~~~~~~~~~~ out = \{ c ~\vert~ (c,\_) \in \text{adjOut}(PG_{i1},m) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord^A_i(f_{pg}(m)) : (in,q_N) \rightarrow (out,q_M) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (bs,q_N) ~\vert~ (\_,q_N) \in pin, bs=\{ b ~\vert~ (b,q_N) \in ping \} \}) \\
     ~~~~~~~~~~~~~~~~~~ out = \{ c ~\vert~ (c,\_) \in \text{adjOut}(PG_{i1},m) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = ord_{i1}(m) : (in,q_N) \rightarrow (out,q_M) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = con(ord^A_i(M) : (in,q_N) \rightarrow (out,q_M),l_{ij},\ell,\Gamma,f,G) ~] \\
  \end{array} \]%
  ...
  \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_N) = \{ (BS,q_N) ~\vert~ (\_,q_N) \in pin, BS=\{B ~\vert~ (B,q_N) \in pin \} \} \\
     ~~~~~~~~~~~~~~~~~~ out = \{ C ~\vert~ (C,\_) \in \text{adjOut}(PG^A_i,M) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_N} = \textbf{if}~ in=\{ G.s \} \text{ and } l_{ij} \neq \ell ~\textbf{then}~ \bullet \\ 
 ...
 \[ \begin{array}{l}
     ...
     ~~~~~~~~~~~~~~~~~~ (in,q_n) = \{ (bs,q_n) ~\vert~ (\_,q_n) \in pin, bs=\{ b ~\vert~ (b,q_n) \in ping \} \}) \\
     ~~~~~~~~~~~~~~~~~~ out = \{ c ~\vert~ (c,\_) \in \text{adjOut}(PG_{ij},m) \} \\
     ~~~~~~~~~~~~~~~~~~ ma_{q_n} = ord_{ij}(m) : (in,q_n) \rightarrow (out,q_m) ~] \\
  \end{array} \]%

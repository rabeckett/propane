...
best to design templates despite the assembly-language-like primitives for network configuration.
They hope their templates
will work properly and test concrete instantiations of them using simulations, but
...
some risk of temporary instability in a network, so minimizing such changes
...
thereby providing a degree of fault tolerance if one aggregation router
were to fail.

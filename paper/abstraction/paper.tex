...
for each node in the abstract Product Graph, 
...
The translation from the Product Graph to per-device templates that run the distributed BGP protocol involves several ideas.

...
such abstraction for the datacenter networks. The network is partitioned into 5 different roles:
local tor (TL), global tor (TG), local aggregator (AL), global aggregator (AG), and spine (S).
Each router in the concrete topology maps to exactly one abstract role. 

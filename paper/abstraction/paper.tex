...
\begin{figure}[t!]
  ...
  \end{center}
  \vspace{-.6em}
  \caption{Fault-tolerance analysis precision for various topologies with shortest path routing.}
...
Hypercube variants can be used as an alternative to Clos-style topologies for networks with port density routers. The HyperX~\cite{hyperx} topology is a generalization of the hypercube and butterfly topologies, which includes parameters $L$ for the lattice dimension of the network, and $S_i$ for the node multiplicity of each dimension $i$.

...
\newcommand{\inference}[7]{
    ...
    \node at (#1, -.8) {#2};
    \node at (#1, 3.3) {#4};
    \draw [] (#1, 2.5) circle [radius=0.45] node {$n$};
    \draw [] (#1, 0) circle [radius=0.45] node {$m$};
    \draw [->] (#1, .45) -- (#1, 2.05);
}

\newcommand{\inferencenobox}[7]{
    \node[anchor=west] at (#1 + .4, 1.25) {#3};
    \node[anchor=east] at (#1 - .4, 1.25) {\textbf{#5}};
    \node at (#1 + .34, .6) {#6};
    \node at (#1 + .34, 1.9) {#7};
    \node at (#1, -.8) {#2};
    \node at (#1, 3.3) {#4};
    \draw [] (#1, 2.5 - .2) circle [radius=0.45] node {$n$};
    \draw [] (#1, .2) circle [radius=0.45] node {$m$};
    \draw [->] (#1, .2 + .45) -- (#1, 2.5 - .45 - .2);
}
...
\newcommand{\inferencetwo}[1]{
    ...
    \node at (#1 + .11, 1.9) {$e_2$};
    \node at (#1 + 2 + .11, .6) {$e_3$};
    \node at (#1 + .11 + .8, 1.9) {$e_4$};
    \node at (#1 - 1, -.8) {L$(j,k)$};
    \node at (#1 +. 5, 3.3) {S$(min(j*k,g),1)$};
    \node at (#1 + 2, -.8) {L$\big( min(j, g *\frac{e_4}{e_3}),1\big)$};
    \node at (#1, 3.3) {};
    \draw [] (#1 + .5, 2.5) circle [radius=0.45] node {$n$};
    \draw [] (#1 - 1, 0) circle [radius=0.45] node {$m$};
    \draw [] (#1 + 2, 0) circle [radius=0.45] node {$o$};
    \draw [->] (#1 - 1, .45) -- (#1 + .5, 2.05);
    \draw [<-] (#1 + 2, .45) -- (#1 + .5, 2.05);
}

\newcommand{\inferencelocal}[1]{
    \inferencenobox{#1}{L$_1(j,k)$}{}{L$_2(j',k')$}{I-local}{}{}
    \inferencenobox{#1+3}{$\ldots$ L$_P$ L$_1(j,k)$}{}{$\ldots$ L$_P$ L$_2(j',k')$}{}{}{}
    \node[anchor=east] at (#1 + 3 - .6, 2.6) {P};
    \draw[dashed] (#1+2 - .2, -.44) rectangle (#1+3+1 + .1, 2.95);
}

\newcommand{\inferenceglobal}[1]{
    \inferencenobox{#1}{L$_1(j,k)$}{}{L$_2(j',k')$}{I-global}{}{}
    \inferencenobox{#1+3}{$\ldots$ L$_P$ L$_1(j,k)$}{}{$\ldots$ A$_P$ L$_2(j',k')$}{}{}{}  
    \node[anchor=east] at (#1 + 3 - .6, .54) {P};  
    \node[anchor=east] at (#1 + 3 - .6, 2.6) {Q};
    \draw[dashed] (#1+2 - .2, -.44) rectangle (#1+3+1 + .1, .9);
    \draw[dashed] (#1+2 - .2, 1.6) rectangle (#1+3+1 + .1, 2.95);
}
...
\begin{figure*}[t!]
  ...
  \begin{tikzpicture}
    ...
    \inferencetwo{0}
    \node[anchor=west] at (2,2.4) {where $g=n-\dfrac{(m-j)*e_1}{e_2}$};
    \inference{11}{L$(j,k)$}{$bisec(X)$}{A$(1,min(k,X))$}{I-bisec}{}{}
  \end{tikzpicture}
  \end{minipage}

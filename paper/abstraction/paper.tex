...
%
Our templates are correct by design and evolution friendly. 
When the network evolves from
...
{\em Any} concrete instance of the abstract topology will adhere to the given fault tolerance property.

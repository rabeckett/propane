...
\begin{figure}[t!]
  \centering
  \includegraphics[width=1.02\columnwidth]{figures/templates}
  \caption{Example of a small part of a router template for the datacenter spine role.}
  \label{fig:example2}
  \vspace{-1em}
\end{figure}

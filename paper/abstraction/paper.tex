...
many critical services; every second of downtime is
costly at best and dangerous at worst.  Unfortunately, it is an enormous
...
update, is the single largest cause of these
...
Moreover,
template construction is a low-level, manual process:  
network engineers do their
best to design templates using assembly-language-like primitives.
They hope their templates
that will work properly, test them using simulations, but
there is no support for verification of key network-wide properties 
such as connectivity and fault tolerance. In addition,
...
\emph{any} valid concrete topology.

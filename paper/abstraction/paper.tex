...
\begin{figure*}[t!]
  ...
  \begin{tikzpicture}
    ...
    \inferencenobox{11}{L$(j,k)$}{$mincut(X)$}{A$(1,min(k,X))$}{I-mincut}{}{}
  \end{tikzpicture}
  \end{minipage}

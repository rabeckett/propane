...
We use a fat tree topology and scale the size of the topology according the the number of pods $k$. The abstract topology uses one abstract node for each tier of the datacenter with an additional node for separate local and global ToRs.

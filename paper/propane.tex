...
%
\ratul{Does this capture the differences correctly?}
...
\dpw{Note that I did not use an asterix above but used disjunction.}
...
aggregation for the prefixes in the set \CD{AGG} is performed from 

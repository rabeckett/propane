...
policies~\cite{x,y,z} in a few important ways. First, control-plane
policies must account for all failures at specification time; there is
...
examples described in the previous section, introducing key aspects of
...
\sysname allows the operator to configure the network with the
...
\CD{PG*} may be sent either from other routers in the data center, or

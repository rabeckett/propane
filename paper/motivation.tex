...
\CD{R1}. % Implementing P2 properly will require MEDs to be
% appropriately configured. 
\todd{I commented out the sentence about MEDs for P2, because the next
  two sentences seem to be about P2 instead of P3 and P4, which it
  originally said.  Please check}  To implement P2, the operators can assign communities that

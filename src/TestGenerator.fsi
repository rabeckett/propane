...
val genLinkTest : CGraph.T -> int -> Route.Predicate -> Set<Set<CgState*CgState>*Set<CgState*CgState>>
val genPrefTest : CGraph.T -> int -> Route.Predicate -> Set<Set<CgState*CgState>*Set<CgState*CgState>>

...
let displayStats k v e (stats: Abgp.Stats) =
    ...
    printfn "%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d" 
        k v e 
        stats.NumPrefixes
...
let writeDcPol file ((topo, pfxMap, tierMap): _ * Topology.Examples.Prefixes * Topology.Examples.Tiers) = 
    let mutable t0 = []
    let mutable t1 = []
    let mutable t2 = []
